...
export class CardService {
    ...
    async getPublicCards(index: number, keyword: string, searchBy: string): Promise<any> {
        ...
        let result = await this.knex
            ...
            .select("user_cards.user_id","user_cards.card_id", "user_cards.card_image", "user_cards.first_name", "user_cards.last_name", "user_cards.title", "user_cards.company_name", "user_cards.address", "user_cards.default_image_index", "user_cards.card_image", "user_cards.email", "user_cards.website", "user_cards.image_format", "user_cards.image_bg", "user_cards.profile_pic")
            .from("user_cards")
